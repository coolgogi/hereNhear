...
class _ChatListState extends State<MyChatList>
  ...
  @override
  void didUpdateWidget(covariant MyChatList oldWidget) {
    ...
    final diffResult = calculateListDiff<Object>(
      ...
      equalityChecker: (item1, item2) {
        if (item1 is Map<String, Object> && item2 is Map<String, Object>) {
          final message1 = item1['message']! as types.MyMessage;
          final message2 = item2['message']! as types.MyMessage;
  ...
  void _scrollToBottomIfNeeded(List<Object> oldList) {
    try {
      ...
      if (oldItem != item && item is Map<String, Object>) {
        final message = item['message']! as types.MyMessage;
