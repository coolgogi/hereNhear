            ...
            children: <Widget>[
              Padding(
                ...
                child: Text(
                  '한화 이글스를 찾아간 VJ특공대',
                  style: TextStyle(
                      fontFamily: 'Roboto', fontSize: 27, color: Colors.black),
                ),
              ),
              Padding(
                      ...
                      Obx(
                        () => GestureDetector(
                          onTap: (() async {
                            ...
                            controller.stopFlag.value == false
                                ? player.play()
                                : player.pause();
                          }),
                          child: Container(
                            child: Center(
                              child: controller.stopFlag.value
                                  ? Image.asset(
                                      'assets/images/playButton2.png',
                                      width: 150,
                                    )
                                  : Image.asset(
                    ...
                    CircleAvatar(
                        ...
                        child: Obx(
                          () => GestureDetector(
                            ...
                            child: CircleAvatar(
                              radius: 45.r,
                              backgroundColor: controller.goodFlag.value
                                  ? Color(0xFF618051)
                                  : Colors.white,
                              child: Text(
                                '잘해요',
                                style: TextStyle(
                                    fontSize: 27,
                                    color: controller.goodFlag.value
                                        ? Colors.white
                                        : Color(0xFF618051),
                                    fontWeight: FontWeight.bold),
                              ),
                    ...
                    CircleAvatar(
                        ...
                        child: Obx(
                          () => GestureDetector(
                            ...
                            child: CircleAvatar(
                              radius: 45.r,
                              backgroundColor: controller.funFlag.value
                                  ? Theme.of(context).colorScheme.secondary
                                  : Colors.white,
                              child: Text(
                                '웃겨요',
                                style: TextStyle(
                                    fontSize: 27,
                                    color: controller.funFlag.value
                                        ? Colors.white
                                        : Theme.of(context)
                                            .colorScheme
                                            .secondary,
