...
class _FeedPageState extends State<FeedPage> {
  ...
  Future<int> deleteDoc(var doc) async {
    try {
          ...
          builder:
            ...
            return FutureBuilder(
                ...
                builder: (BuildContext context,
                  ...
                  currentUserDoc = snapshot2.data!.docs
                      .where((element) => element['uid'] == uid);
                  currentUserDisplayName =
                      currentUserDoc.first.get('displayname');
                  currentUserPhotoURL =
                      currentUserDoc.first.get('userPhotoURL');
  ...
  Widget postItem(
      ...
      QueryDocumentSnapshot<Object?>? doc2,
      String displayName,
      String userPhotoURL) {
    if (doc2!['imageURL'] == '') {
      return Column(
